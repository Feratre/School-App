  ...
  static void _showNotificationsSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (ctx) {
        final sc2 = ctx.sc;
        final notifications = [
          (icon: PhosphorIconsFill.checkCircle, color: sc2.sage, title: 'Trascrizione completata', body: 'La lezione "Aromatici e Benzene" è stata trascritta al 100%.', time: '2 min fa'),
          (icon: PhosphorIconsFill.fire, color: sc2.accent, title: 'Verifica tra 4 giorni!', body: 'Chimica — ricorda di completare il Modulo 3 oggi.', time: '1 ora fa'),
          (icon: PhosphorIconsFill.sparkle, color: sc2.info, title: 'Piano AI aggiornato', body: 'Il tuo piano di Matematica è stato aggiornato con nuovi esercizi.', time: '3 ore fa'),
          (icon: PhosphorIconsFill.bookOpen, color: sc2.brass, title: 'Nuovo compito', body: 'LUCCHELLI ELISABETTA ha assegnato nuovi esercizi di Matematica.', time: 'Ieri'),
        ];
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text('Notifiche', style: AppTheme.d(22, weight: FontWeight.w700, color: sc2.text)),
                  Container(
                    ...
                    child: Text('${notifications.length} nuove', style: AppTheme.s(11, weight: FontWeight.w600, color: sc2.danger)),
                  ),
                ],
              ),
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(n.title,
                                      style: AppTheme.d(13, weight: FontWeight.w700, color: sc2.text),
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis),
                                ),
                                const SizedBox(width: 8),
                                Text(n.time, style: AppTheme.s(10, color: sc2.textTertiary)),
                              ],
                            ),
                            const SizedBox(height: 3),
                            Text(n.body, style: AppTheme.s(12, color: sc2.textSecondary), maxLines: 2),
                          ],
                        ),
                      ),
                    ],
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          'R',
                          style: AppTheme.d(20, weight: FontWeight.w700, color: sc.bg),
                        ),
                      ),
                    ),
                    const SizedBox(width: 12),
                    Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Text('Ciao, Reda', style: AppTheme.d(18, weight: FontWeight.w700, color: sc.text)),
                          ],
                        ),
                        Text('Bentornato sul tuo tutor AI', style: AppTheme.s(12, color: sc.textSecondary)),
                      ],
                    ),
                  ],
                ),
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Container(
                            width: 8,
                            height: 8,
                            decoration: BoxDecoration(color: sc.danger, shape: BoxShape.circle),
                          ),
                        ),
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text('${school.studyStreak}', style: AppTheme.d(14, weight: FontWeight.w700, color: sc.accent)),
                        ],
                      ),
                    ),
                  ],
            ...
            Text(
              dateStr.toUpperCase(),
              style: AppTheme.d(12, weight: FontWeight.w600, color: sc.textTertiary, letterSpacing: 2),
            ),
            const SizedBox(height: 10),
            ...
            SoftCard(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    activePlan.title,
                    style: AppTheme.d(28, weight: FontWeight.w700, color: sc.text, letterSpacing: 0.5),
                  ),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Icon(PhosphorIconsFill.microphone, size: 24, color: sc.brass),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('UPLOAD REGISTRAZIONE', style: AppTheme.d(14, weight: FontWeight.w700, color: sc.text)),
                          const SizedBox(height: 3),
                          Text('Carica audio lezione per trascrizione e piano AI', style: AppTheme.s(12, color: sc.textSecondary)),
                        ],
                      ),
                    ),
                    Icon(PhosphorIconsRegular.caretRight, size: 16, color: sc.textTertiary),
                  ],
                ),
              ),
            ),
            ...
            Text('SCADENZE & COMPITI', style: AppTheme.d(12, weight: FontWeight.w600, color: sc.textSecondary, letterSpacing: 2.5)),
            const SizedBox(height: 10),
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Icon(PhosphorIconsRegular.bookOpenText, size: 20, color: sc.warn),
                            Pill(label: 'DOMANI', bg: sc.warn.withValues(alpha: 0.15), fg: sc.warn, fontSize: 10),
                          ],
                        ),
                        const SizedBox(height: 12),
