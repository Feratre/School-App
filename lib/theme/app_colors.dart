...
@immutable
class SchoolColors extends ThemeExtension<SchoolColors> {
  const SchoolColors({
  ...
  static const dark = SchoolColors(
  ...
  static const light = SchoolColors(
  ...
  @override
  SchoolColors lerp(SchoolColors? other, double t) {
...
extension SchoolColorsX on BuildContext {
  SchoolColors get sc => Theme.of(this).extension<SchoolColors>()!;
}
